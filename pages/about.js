    ...
    return (
      <Container>
        ...
        <Section>
          ...
          >
            <strong>Hello, I'm Samuel Ironkwe </strong>
            I am a <strong>software engineer</strong> in the early years of my career.
          </Paragraph>
          <Paragraph>
            ...
            Right now, when I'm not juggling client work, I'm building out cruiseo.xyz for the world to get around cheaper and more sustainably by  carpooling. Originally from Nigeria, I reside in <strong> Winnipeg, Manitoba, </strong> which has a growing tech scene. My passion? Creating software that helps small businesses scale and grow. Dive into my codebase over at <a href='/github.com/SamIron0' target="_blank">github.com/SamIron0</a> 💻✨
          </Paragraph>
          <Paragraph>
