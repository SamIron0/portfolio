...
function Projects(props) {
  ...
  const description = `I'm obsessed with taking on new projects and <strong>building scaleable </strong>. Here you can navigate to <strong>${getTotalProjects()} different</strong> websites and apps that I built.`
